...
def generate_transaction_data(sender_bitcoin_address, receiver_bitcoin_address, amount: int) -> int:
    result = {
...
def convert_transaction_data_to_bytes(transaction_data: dict):
    ...
    result = json.dumps(new_transaction_data, indent=2).encode('utf-8')
    return result